...
Outputs per tree:
- `results/trees/{tree}/accessions_with_bad_dates_reset.tsv`: TSV with columns `accession`, `metadata_date`, `inferred_date` listing strains whose dates were reset as outliers (empty table if none)
